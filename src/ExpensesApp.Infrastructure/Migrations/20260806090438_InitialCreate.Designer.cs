...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpensesApp.Domain.Entities.Budget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ExpensesApp.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ExpensesApp.Domain.Entities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ExpensesApp.Infrastructure.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ExpensesApp.Domain.Entities.Budget", b =>
                {
                    b.HasOne("ExpensesApp.Domain.Entities.Category", "Category")
                        .WithMany("Budgets")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ExpensesApp.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
