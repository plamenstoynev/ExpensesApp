...
namespace ExpenseTracker.Infrastructure.IntegrationTests.Persistence;
...
{
    private readonly string _dbPath = Path.Combine(Path.GetTempPath(), $"expensetracker-test-{Guid.NewGuid():N}.db");
